...
drop table if exists afl._schedule_factors;

create table afl._schedule_factors (
	team_id			text,
        offensive               float,
        defensive		float,
        strength                float,
...
r.field
from afl.results r
where r.year between 2012 and 2024
);
